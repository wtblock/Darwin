...
// CDarwinDoc construction/destruction
...
void CDarwinDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CDarwinDoc::InitializeSearchContent()
{
...
void CDarwinDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
